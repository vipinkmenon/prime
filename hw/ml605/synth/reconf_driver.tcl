# 
# Project automation script for reconf_driver 
# 
# Created for ISE version 14.6
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source reconf_driver.tcl), then you can
...
set myProject "reconf_driver"
set myScript "reconf_driver.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../src/config_ctrl/icap_controller.v"
   xfile add "../src/ipcore_dir/config_buffer.xco"
   xfile add "../src/ipcore_dir/user_adpt_fifo.xco"
   xfile add "../src/ipcore_dir/user_fifo.xco"
   xfile add "../src/ipcore_dir/user_strm_fifo.xco"
   xfile add "../src/ipcore_dir/v6_pcie_v2_5.ngc"
   xfile add "../src/pcie_if/pcie_app.v"
   xfile add "../src/pcie_if/reg_file.v"
   xfile add "../src/pcie_if/rx_engine.v"
   xfile add "../src/pcie_if/tx_engine.v"
   xfile add "../src/pcie_if/v6_pcie_top.v"
   xfile add "../src/pcie_if/v6_pcie_v2_5.v"
   xfile add "../src/top.v"
   xfile add "../src/user_logic_if/user_dma_req_arbitrator.v"
   xfile add "../src/user_logic_if/user_logic_adapter.v"
   xfile add "../src/user_logic_if/user_logic_bb.v"
   xfile add "../src/user_logic_if/user_logic_top.v"
   xfile add "../src/user_logic_if/user_pcie_stream_generator.v"
   xfile add "../src/v6_top.ucf"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Other Bitgen Command Line Options" "-g Compress" -process "Generate Programming File"
   ...
   project set "Work Directory" "F:/RESEARCH/2.my_git/prime/hw/ml605/synth/xst" -process "Synthesize - XST"
